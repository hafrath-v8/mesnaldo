...
export default function CopaVsEuro() {
  const players = [
    { 
      name: "Messi", 
  ...
  return (
    <div className="w-full mb-4 mt-4 max-w-5xl mx-auto bg-gray-900 p-6 rounded-lg border border-gray-700">

      {/* Header */}
      <div className="text-center mb-4">
        <h2 className="text-xl font-semibold text-white mb-1">Copa América vs Euro Efficiency</h2>
        <p className="text-sm text-gray-400">Tournament contributions per appearance</p>
      </div>
