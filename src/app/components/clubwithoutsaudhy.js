...
export default function GoalsVsAssists() {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto mt-4 bg-gray-900 p-6 rounded-lg border border-gray-700">
      {/* Header */}
      <div className="text-center mb-4">
        <h2 className="text-xl font-semibold text-white mb-1">All Time Club</h2>
        <p className="text-sm text-gray-400">Top Leagues Only (No SPL/MLS)</p>
      </div>
