...
export default function RonaldoMatches({ matches, total }: MatchesProps) {
  ...
  return (
    <Layout title="Ronaldo Match Log | All 1,330 Matches">
      <section className="py-8">
        <h1 className="text-3xl font-bold mb-2">Cristiano Ronaldo — Match Log</h1>
